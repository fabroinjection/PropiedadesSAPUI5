		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsofttekpropiedadesaca-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsofttekpropiedadesaca-display": {
								"semanticObject": "comsofttekpropiedadesaca",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.softtek.propiedadesaca",
									"url": sap.ui.require.toUrl("com/softtek/propiedadesaca")
								}
							}
						}
					}
